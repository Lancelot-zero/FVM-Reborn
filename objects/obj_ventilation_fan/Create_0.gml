sprite_index = get_load_sprite("spr_ventilation_fan");  //转化额外添加保证触发
...
event_user(0)
sprite_index = get_load_sprite("spr_ventilation_fan")
if shape == 1{
	sprite_index = get_load_sprite("spr_ventilation_fan_1")
}
else if shape == 2{
	sprite_index = get_load_sprite("spr_ventilation_fan_2")
}
// ========== 特定属性默认值 ==========
if shape >= 1{
	hp *= 5
