...
switch state{
	...
	case BOSS_STATE.SKILL4:
		...
		if skill_timer <= 120{
			...
			sprite_index = get_load_sprite("spr_mouse_train_3_head_skill_1")
			if hp > maxhp * hurt_rate{
		...
		if timer == 1{
			...
			skill_4_erase_row[0] = boss_random(self, 4,5)
			skill_4_erase_row[1] = boss_random(self, 2,3)
			skill_4_erase_row[2] = boss_random(self, 0,1)
		}
