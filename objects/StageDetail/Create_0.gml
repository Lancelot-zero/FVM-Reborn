...
function on_create_room() {
    ...
    if (global.network.mode == "server") {
        ...
        if (_check_custom_music(_raw_json,"pre_music") || _check_custom_music(_raw_json,"elite_music") || _check_custom_music(_raw_json,"boss_music")) {
            ...
            _ld[$ "pre_music"]   = get_load_audio("mus_delicious_island_daytime_pre")
            _ld[$ "elite_music"] = get_load_audio("mus_delicious_island_daytime_elite")
            _ld[$ "boss_music"]  = get_load_audio("mus_delicious_island_daytime_boss")
