sprite_index = get_load_sprite("spr_triple_wine_rack");  //转化额外添加保证触发
...
event_user(0)
if shape == 0{
	sprite_index = get_load_sprite("spr_triple_wine_rack")
}
else if shape == 1{
	sprite_index = get_load_sprite("spr_triple_wine_rack_1")
}
else if shape == 2{
	sprite_index = get_load_sprite("spr_triple_wine_rack_2")
}
