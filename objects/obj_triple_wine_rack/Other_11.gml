...
if shape == 1{
	...
	if card_equipped_attire_id(plant_id) == "wine_rack_sagittarius"{
		inst_middle2.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet")
		if shape >= 2{
			inst_middle2.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet_1")
		}
	}
}

if card_equipped_attire_id(plant_id) == "wine_rack_sagittarius"{
	inst_up.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet")
	inst_middle.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet")
	inst_down.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet")
	if shape >= 2{
		inst_up.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet_1")
		inst_middle.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet_1")
		inst_down.sprite_index = get_load_sprite("spr_wine_rack_sagittarius_bullet_1")
	}
}
