sprite_index = get_load_sprite("spr_tang_hu_lu");  //转化额外添加保证触发
...
sprite_index = get_load_sprite("spr_tang_hu_lu");
current_level = 1
event_user(0)
if shape == 1{
	sprite_index = get_load_sprite("spr_tang_hu_lu_1")
}
else if shape == 2{
	sprite_index = get_load_sprite("spr_tang_hu_lu_2")
}
// ========== 特定属性默认值 ==========
