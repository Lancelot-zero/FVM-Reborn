...
switch state{
	...
	case BOSS_STATE.SKILL1:
		if grid_row == 0{
			sprite_index = get_load_sprite("spr_mouse_train_3_body_skill_2_2")
		}
		else if grid_row == global.grid_rows-1{
			sprite_index = get_load_sprite("spr_mouse_train_3_body_skill_2_1")
		}
		else{
			sprite_index = get_load_sprite("spr_mouse_train_3_body_skill_2_3")
		}
		if train_head.hp > maxhp * hurt_rate{
