    ...
    if (mouse_check_button_pressed(mb_left)) {
        ...
        if (can_plant && global.flame >= current_cost) {
			...
			if(global.network.mode=="client"){
				...
				if array_contains([obj_wine_bottle_bomb,obj_aquarius_elve,obj_whisky_bomb,obj_kettle_bomb,obj_coke_bomb,obj_bull_firework,obj_magic_chicken,obj_coffee_grounds,obj_firework_dragon,obj_chili_powder],new_plant.object_index){
